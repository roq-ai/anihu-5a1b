...
const notificationMapping: Record<string, NotificationConfigInterface> = {
  'reservation.create': { roles: ['admin', 'vehicle-owner'], key: 'vehicle-reservation', tenantPath: [], userPath: [] },
  'reservation.delete': {
    roles: ['admin', 'vehicle-owner'],
    key: 'reservation-cancellation',
    tenantPath: [],
    userPath: [],
  },
  'vehicle.update': { roles: ['admin', 'user'], key: 'vehicle-update', tenantPath: [], userPath: [] },
};

const ownerRoles: string[] = ['admin'];
const customerRoles: string[] = [];
const tenantRoles: string[] = ['admin', 'vehicle-owner'];
